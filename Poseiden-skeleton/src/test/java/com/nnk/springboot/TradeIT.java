...
public class TradeIT {
    ...
    public void validateTest() throws Exception {
        ...
        this.mockMvc.perform(get("/trade/list")).andDo(print()).andExpect(status().isOk())
                .andExpect(model().attribute("trade", Matchers.hasSize(2)));
    }

    @WithMockUser(value = "user1", password = "Password1@")
    @Test
    void showUpdateFormListTest() throws Exception {
        this.mockMvc.perform(get("/trade/update/26")).andDo(print()).andExpect(status().isOk())
                .andExpect(view().name("trade/update"))
                .andExpect(model().attribute("trade", Matchers.hasProperty("tradeId", is(26))));
    }
    ...
    void deleteTest() throws Exception {
        this.mockMvc.perform(get("/trade/delete/26")).andDo(print())
                .andExpect(redirectedUrl("/trade/list"));
        this.mockMvc.perform(get("/trade/list")).andDo(print()).andExpect(status().isOk())
